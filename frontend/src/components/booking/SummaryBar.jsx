...
export const SummeryBar = ({newBooking})=>{
    ...
    const calculateTotalPrice = () => {
        ...
        const days = Math.round((end - start) / msPerDay); // 四舍五入天数
        const totalPrice = days * price;
        return totalPrice.toFixed(2); // 返回带两位小数的字符串
    };
    const handleOnClick = ()=>{
    ...
    return (
        <div className='flex flex-col text-base text-gray-700'>
            <div className={`flex ${showCompleteSummery ? "slide-up" : "slide-down"} bg-gray-100 shadow pb-2`}>
                {/* <div className='px-6 flex justify-center w-auto'> */}
