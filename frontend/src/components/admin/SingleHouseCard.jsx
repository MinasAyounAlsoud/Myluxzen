...
<div className='py-2 px-10 text-gray-600'>
        { house ? (
            <div className='border border-gray-300 p-2 rounded-lg'>
                ...
                <div>
                    ...
                    <p><span className='text-gray-400 text-sm'>Startdatum:</span> {new Date(house.startDate).toLocaleDateString()}</p>
                    <p><span className='text-gray-400 text-sm'>Enddatum:</span> {new Date(house.endDate).toLocaleDateString()}</p>
                </div>}
                ...
                <div>
                    <span className='text-gray-400 text-sm underline'>Reserviert von Admin</span>
                    <ul>
                    {
        ...
        <div className='mt-10 mb-4 flex space-x-6'>
            <button onClick={handleAdminReserve} className='bg-teal-dark text-white px-4 rounded-full cursor-pointer hover:text-[#FAE1A8]'>Admin Reservieren </button>
