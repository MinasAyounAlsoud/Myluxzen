...
import { formatLocalDate, normalizeDate } from '../../utils/commenBookFunc';
    ...
    return (
        <div className="bg-gray-200 p-4 rounded w-4/5 mx-auto">
            <div className="text-center font-bold mb-2">
                {new Date(startDate).toLocaleDateString()} bis {new Date(endDate).toLocaleDateString()}
            </div>
            <div className="relative bg-gray-300 p-2 rounded flex flex-col gap-4">
                {orders.map((order, index) => {
                    ...
                    // console.log("BookingTimeline, start",start);
                    // console.log("BookingTimeline, end",end);
