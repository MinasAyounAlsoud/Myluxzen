...
export function SingleHouseQueryForm({ handleSearch }) { 
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="space-y-4 px-10 py-2 lg:w-4/5 mx-auto my-10 px-10">
            <div>
                <label className="block text-sm font-medium text-gray-600"><span className='text-sm text-gray-400'>Haustyp:</span></label>
            ...
            <div>
                <label className="block text-sm font-medium text-gray-700"><span className='text-sm text-gray-400'>Admin Reseviert:</span></label>
            ...
            <div>
                <label className="block text-sm font-medium text-gray-700"><span className='text-sm text-gray-400'>Gäste Reseviert:</span></label>
                <div className='flex space-x-4'>
                    <label>
                        <input
                            type="radio"
            ...
            <div>
                <label className="block text-sm font-medium text-gray-700"><span className='text-sm text-gray-400'>Haus Nummer:</span></label>
                <input
                    type="text"
                    name="houseNum"
