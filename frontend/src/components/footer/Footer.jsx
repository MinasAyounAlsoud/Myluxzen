        ...
        <div className="relative z-10 max-w-[90%] md:max-w-[80%] mx-auto grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-20">
          ...
          <div>
            ...
            <ul className="text-off-white space-y-3">
              ...
              {/* 🔹 Lien spécial : Kontaktieren Sie uns */}
              <li>
                <span
                  onClick={() => setShowContactModal(true)}
                  className="cursor-pointer hover:text-caramel transition duration-300 ease-in-out transform hover:scale-105 inline-block relative group"
                >
          ...
          <div>
            ...
            <p className="text-off-white text-sm mb-1">E-Mail: kontakt@myluxzen.com</p>
            <p className="text-off-white text-sm mb-4">Telefon: +49 123 456 789</p>
